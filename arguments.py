...
def get_argument_parser():
    ...
    parser.add_argument('--logger_name', default='/home/ubuntu/Students/BCY/vse_infty-master/runs/runX/log',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='/home/ubuntu/Students/BCY/vse_infty-master/runs/runX/checkpoint',
    ...
    parser.add_argument('--trade_off', default=0.02, type=float, help='Trade-off parameter for path regularization.')
