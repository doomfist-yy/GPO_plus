...
def main():
    ...
    parser.add_argument('--dataset', default='f30k',
                        help='coco or f30k')
    parser.add_argument('--data_path', default='/home/ubuntu/Students/BCY/vse_infty-master/data/coco')
    ...
    if opt.dataset == 'coco':
        weights_bases = [
            '/home/ubuntu/Students/BCY/vse_infty-master/runs/coco_butd_region_bert',
            # '/home/ubuntu/Students/BCY/vse_infty-master/runs/coco_butd_grid_bert',
            # '/home/ubuntu/Students/BCY/vse_infty-master/runs/coco_wsl_grid_bert',
        ]
    elif opt.dataset == 'f30k':
        weights_bases = [
            '/home/ubuntu/Students/BCY/vse_infty-master/runs/f30k_butd_region_bert',
            # '/home/ubuntu/Students/BCY/vse_infty-master/runs/f30k_butd_grid_bert',
            # '/home/ubuntu/Students/BCY/vse_infty-master/runs/f30k_wsl_grid_bert',
        ]
    else:
...
# CUDA_VISIBLE_DEVICES=0 python3 eval.py --dataset coco --data_path /home/ubuntu/Students/BCY/vse_infty-master/data/coco

# CUDA_VISIBLE_DEVICES=1 python3 eval.py --dataset f30k --data_path /home/ubuntu/Students/BCY/vse_infty-master/data/f30k
